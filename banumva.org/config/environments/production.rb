...
#  Rails.cache.clear
  ...
  config.active_record.observers = :signatures_observer, :contributions_observer, :perspectives_observer, :user_observer
  ...
  config.action_mailer.smtp_settings = {
    ...
    :address => "mail.banumva.org" ,

    :port => 587,

    :domain => "mail.banumva.org",
